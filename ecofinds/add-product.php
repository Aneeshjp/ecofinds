...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($title) || empty($description) || $price <= 0 || $categoryId <= 0) {
        ...
        if (!$error) {
            if (createProduct($title, $description, $price, $categoryId, $user['id'], $imagePath)) {
                ...
                <div class="card form-card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="alert alert-success" role="alert">
                            ...
                            <br><a href="my-products.php" class="btn btn-sm btn-outline-success mt-2">View My Products</a>
                        </div>
                        <?php endif; ?>
                        ...
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="mb-4">
                                ...
                                <small class="text-muted">Optional: Upload a product image (JPEG, PNG, GIF, max 5MB)</small>
                            </div>
